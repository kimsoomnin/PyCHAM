...
# used to ensure that PyCHAM runs without error, using the travis continuous integrator
# tool
...
# delete any pre-existing output from Travis CI
path_output = str(dirpath + '/PyCHAM/output/Example_Run/Example_output_Travis_CI')
...
for i in range(len(in_list)):
	...
	# the time step (s) to be used for updating initial values/constants
	if key == 'update_step':
