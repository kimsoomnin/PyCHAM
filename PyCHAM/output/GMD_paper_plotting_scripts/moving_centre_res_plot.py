...
# open saved files
output_by_sim = str(cwd + '/mov_cen_output/empty_chem/test_31815_coag_100diss_100dens_200p00g')
...
# open saved files
output_by_sim = str(cwd + '/mov_cen_output/empty_chem/test_Zhang_60sb_273.15K')
