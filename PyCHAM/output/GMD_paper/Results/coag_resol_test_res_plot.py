...
output_by_sim = '/Users/Simon_OMeara/Documents/Manchester/postdoc_stuff/box-model/PyCHAM_Gitw/PyCHAM/output/coag_simple_chem/coag_scheme_test'
...
plt.semilogy(t_array, y[:,0], 'x')
plt.semilogy(t_array, y[:,1], '+')
print(y[:,0])
print(y[:,1])
plt.show()
...
ax0.text(0.1,3e5, '$\Delta nv_{60 s} = $' + str(nv_change) + '$\,\%$')
...
ax0.text(0.1,1e5, '$\Delta nv_{600 s} = $' + str(nv_change) + '$\,\%$')
...
ax0.text(0.1,3.7e4, '$\Delta nv_{6000 s} = $' + str(nv_change) + '$\,\%$')

ax0.set_title('8 size bins')
ax0.legend()
ax0.set_ylabel('$dN/d \mathrm{log_{10}}D_p\, \mathrm{(\#/cm^{3})}$')
...
ax1.text(0.1,3.0e5, '$\Delta nv_{60 s} = $' + str(nv_change) + '$\,\%$')
ax1.set_title('32 size bins')
...
ax1.text(0.1,1.0e5, '$\Delta nv_{600 s} = $' + str(nv_change) + '$\,\%$')
...
ax1.text(0.1,3.7e4, '$\Delta nv_{6000 s} = $' + str(nv_change) + '$\,\%$')
...
ax2.text(0.1,3.0e5, '$\Delta nv_{60 s} = $' + str(nv_change) + '$\,\%$')
ax2.set_title('128 size bins')
...
ax2.text(0.1,1.0e5, '$\Delta nv_{600 s} = $' + str(nv_change) + '$\,\%$')
...
ax2.text(0.1,3.7e4, '$\Delta nv_{6000 s} = $' + str(nv_change) + '$\,\%$')
...
ax3.text(0.3,3.0e5, '$\Delta nv_{60 s} = $' + str(nv_change) + '$\,\%$')
...
ax3.text(0.3,1.0e5, '$\Delta nv_{600 s} = $' + str(nv_change) + '$\,\%$')
...
ax3.text(0.3,3.7e4, '$\Delta nv_{6000 s} = $' + str(nv_change) + '$\,\%$')
ax3.legend()
ax3.set_xlabel('$D_p\, \mathrm{(\mu m)}$')
ax3.set_ylabel('$dN/d \mathrm{log_{10}}D_p\, \mathrm{(\#/cm^{3})}$')
...
ax4.text(1.0e-2,3.0e0, '$\Delta nv_{60 s} = $' + str(nv_change) + '$\,\%$')
...
ax4.text(1.0e-2,1.0e0, '$\Delta nv_{600 s} = $' + str(nv_change) + '$\,\%$')
# 32 size bins, 6000 s ----------------------------------------------------------------------
# open saved files
...
ax4.text(1.0e-2,3.7e-1, '$\Delta nv_{6000 s} = $' + str(nv_change) + '$\,\%$')

ax4.set_xlabel('$D_p\, \mathrm{(\mu m)}$')
...
ax5.text(1.0e-2,3.0e0, '$\Delta nv_{60 s} = $' + str(nv_change) + '$\,\%$')
...
ax5.text(1.0e-2,1.0e0, '$\Delta nv_{600 s} = $' + str(nv_change) + '$\,\%$')
...
ax5.text(1.0e-2, 3.7e-1, '$\Delta nv_{6000 s} = $' + str(nv_change) + '$\,\%$')
ax5.set_xlabel('$D_p\, \mathrm{(\mu m)}$')

plt.show()
fig.savefig('coag_resol_test_plot.png')