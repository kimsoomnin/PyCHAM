...
ax0.set_ylabel('$dN/d \mathrm{log_{10}}D_p\, \mathrm{(\#/cm^{3})}$', size=14)
...
ax3.yaxis.set_tick_params(size=12)
ax3.xaxis.set_tick_params(size=12)
...
ax3.set_ylabel('$dN/d \mathrm{log_{10}}D_p\, \mathrm{(\#/cm^{3})}$', size=14)
...
ax5.xaxis.set_tick_params(size=12)
