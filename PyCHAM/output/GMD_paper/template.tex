...
\runningtitle{PyCHAM (v1.3.3): Chemistry and Aerosol Microphysics in Python}
...
\end{supertabular}
\belowtable{Table containing the PyCHAM variable inputs and their associated descriptions.} % Table Footnotes
\end{center}
